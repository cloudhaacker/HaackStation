...
namespace soundtouch
{
	...
	#if (defined(SOUNDTOUCH_ALLOW_SSE) && SOUNDTOUCH_ALLOW_SSE) || defined(__SSE__) || (defined(SOUNDTOUCH_USE_NEON) && SOUNDTOUCH_USE_NEON)
		#ifdef SOUNDTOUCH_ALLOW_NONEXACT_SIMD_OPTIMIZATION  // patched: #if -> #ifdef for MSVC
