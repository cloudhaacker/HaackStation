...
void HaackApp::init() {
	...
	m_browser->setShelfEnabled(ShelfMode::RECENTLY_PLAYED, m_haackSettings.shelfEnabled[1]);
	m_browser->setShelfEnabled(ShelfMode::FAVORITES,       m_haackSettings.shelfEnabled[2]);
